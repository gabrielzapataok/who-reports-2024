const CHART_ID = "exec_summary_stacked-2";
const KENDO_CHART_ID = "#" + CHART_ID;
const SOURCE_LINK = "";
const SOURCE_TITLE = "WHO internal data: outcome of the prioritization exercise.";
...
function createChart() {
    $(KENDO_CHART_ID).kendoChart({
        title: {
            text: "Outcome prioritization for 2024-2025",
            align: "left",
            color: "white",
        },
        subtitle: {
...
renderFooter(CHART_ID, SOURCE_LINK, SOURCE_TITLE);

$(".export-pdf").click(function () {
    $(KENDO_CHART_ID).getKendoChart().saveAsPDF();
});