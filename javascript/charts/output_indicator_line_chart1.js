...
const CHART_ID_4 = "output_indicator_line_chart1";
const KENDO_CHART_ID_4 = "#" + CHART_ID_4;
const SOURCE_LINK_4 = "https://open.who.int/2022-23/indicators";
const SOURCE_TITLE_4 = "WHO | Programme Budget Web Portal";
...
renderFooter4(CHART_ID_4, SOURCE_LINK_4, SOURCE_TITLE_4);

$(".export-pdf-4").click(function () {
    $(KENDO_CHART_ID_4).getKendoChart().saveAsPDF();
});