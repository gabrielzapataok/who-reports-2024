...
const CHART_ID_4_1 = "output_indicator_line_chart2";
const KENDO_CHART_ID_4_1 = "#" + CHART_ID_4_1;
const SOURCE_LINK_4_1 = "https://open.who.int/2022-23/indicators";
const SOURCE_TITLE_4_1 = "WHO | Programme Budget Web Portal";
...
renderFooter4(CHART_ID_4_1, SOURCE_LINK_4_1, SOURCE_TITLE_4_1);

$(".export-pdf-4").click(function () {
    $(KENDO_CHART_ID_4_1).getKendoChart().saveAsPDF();
});